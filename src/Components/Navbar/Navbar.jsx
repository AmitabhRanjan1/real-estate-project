        ...
        <div>
            <div className="navbar bg-base-100 shadow-lg">
                    ...
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            ...
                            <NavLink className={({ isActive }) =>
                                isActive ? 'text-[#0E46A3]' : 'text-black'} to={"/listedbooks"}>Listed Books</NavLink>
                            <NavLink className={({ isActive }) =>
                                isActive ? 'text-[#0E46A3]' : 'text-black'} to={"/read"}>Pages to Read</NavLink>
                            <NavLink className={({ isActive }) =>
                                isActive ? 'text-[#0E46A3]' : 'text-black'} to={"/about"}>About Vive</NavLink>
                            <NavLink className={({ isActive }) =>
                                isActive ? 'text-[#0E46A3]' : 'text-black'} to={"/community"}>Community</NavLink>
                        </ul>
                    </div>
                ...
                <div className="navbar-end gap-1 lg:gap-3 ">
                    ...
                    <NavLink className="lg:btn hidden lg:text-base lg:font-bold" to={"/login"}>LogIn</NavLink>
                </div>
            </div>
        </div>
    );
